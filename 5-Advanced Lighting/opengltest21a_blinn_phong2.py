...
vertices_binaryformat = struct.pack(f"{len(planeVertices)}f",*planeVertices)
...
# Load image
floorTextureImage = pygame.image.load("./assets/wood.png")
...
floorTextureImage_data = pygame.image.tobytes(floorTextureImage,"RGBA",True)
# load the texture within the OpenGL context
floorTextureTexture = context.texture(floorTextureImage.get_size(),4,floorTextureImage_data)
...
floorTextureTexture.use(location=0)
