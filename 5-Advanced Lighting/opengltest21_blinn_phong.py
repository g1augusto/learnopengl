...
uniform int CUR_NR_POINT_LIGHTS;
...
void main()
{
        ...
        for(int i = 0; i < CUR_NR_POINT_LIGHTS; i++)
...
moveLight = True
pygame.display.set_caption("Click on the window to enable mouselook -- +/- to add or remove lights")
...
while True:
    ...
    # Point lights
    prog["CUR_NR_POINT_LIGHTS"] = CurrentPointLights
    ...
    for _ in range(CurrentPointLights):
        if moveLight:
    ...
    for event in pygame.event.get():
        if  event.type == pygame.QUIT:
            ...
            if event.button == 1:  # Left mouse button
                ...
                pygame.display.set_caption("Mouselook enabled - F11 to release -- +/- to add or remove lights")
            ...
            if event.key == pygame.K_ESCAPE:
                ...
                if CurrentPointLights < PointLights:
                    CurrentPointLights += 1
            elif event.key == pygame.K_MINUS:
                if 0 < CurrentPointLights <= PointLights:
                    CurrentPointLights -= 1
