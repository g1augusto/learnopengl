...
# Access the uniform variable and assign it a texture unit (10) (it will be then used by the texture binding)
prog["ourTexture"] = 10

# bind the texture to the texture unit related to the uniform variable
texture.use(location=10)
...
vbo_parameters = [
    (vbo,"3f 3f 2f","aPos","aColor","aTexCoord")
]
