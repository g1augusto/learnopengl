...
vertices1_binaryformat = struct.pack("9f",*vertices1)
vertices2_binaryformat = struct.pack("9f",*vertices2)

# Define VBO (Vertex Buffer Object) containing vertex data
vbo1 = context.buffer(vertices1_binaryformat)
vbo2 = context.buffer(vertices2_binaryformat)
...
vao1 = context.vertex_array(prog,vbo1,"aPos")
vao2 = context.vertex_array(prog,vbo2,"aPos")
