...
Excercise:  update a uniform value each frame before drawing the triangle. 
'''
...
while True:
    ...
    greenValue = (math.sin(current_time_seconds) / 2.0 ) + 0.5
    # Uniforms can be accessed from the program context in the form of dictionary attributes
    # either for read and write, below we are setting the uniform "ourColor" which apply a color
    # to the drawn triangle, changing it over time in function of time (as calculated previously)
    prog1["ourColor"] = (0.0,greenValue,0.0,1.0)
