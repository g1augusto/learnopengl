...
Excercise:  Create two shader programs where the second program uses a different fragment shader that outputs the color yellow; 
...
vertices_binaryformat = struct.pack("15f",*vertices)
...
indices2_binaryformat = struct.pack("3I",*indices2)
...
ebo2 = context.buffer(indices2_binaryformat)
...
vao2 = context.vertex_array(prog2,vbo_parameters,ebo2)
while True:
