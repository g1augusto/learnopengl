...
Excercise:  Going 3D
            ...
            instead of the lame 2D plane we've been showing so far.
'''
...
model = glm.rotate(model,glm.radians(-55.0),glm.vec3(1.0,0.0,0.0)) # Let's transform our plane a bit by rotating it on the x-axis so it looks like it's laying on the floor
# View Matrix
