...
Excercise:  Diffuse maps
                This is the first step to start making objects with parts reacting  differently to light
                In this example we strat introducing a texture of a woodden box with a metal frame that by the end of the
                set of maps it will react closer to what the real material does
            NOTE: Also the wood on the box is reflecting like it was metal, this will be fixed with "Specular Maps"
