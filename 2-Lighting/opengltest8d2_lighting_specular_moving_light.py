...
Excercise:  Specular Lighting
            ...
            Excercise:  Right now the light source is a boring static light source that doesn't move. 
...
{   
    ...
    // Specular lighting
    float specularStrength = 0.5; // specular intensity of the surface fixed at a certain value
