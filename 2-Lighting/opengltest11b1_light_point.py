...
Excercise:  Directional light
            ...
            Light data structure now contains attenuation parameters to limit impact of the light over 
            distance from the light position to each fragment.
            This is a scaling factor on the top of ambient/diffuse/specular light calculation
            attenuation equation is the following:
                1.0 / (light.constant + light.linear * distance + light.quadratic * (distance * distance));
            where 
                constant
                linear
                quadratic
            are well known parameters to recreate a light that attenuates over a distance:
            ...
            Excercise:  
                        ...
                        CTRL + mouse scroll: change radius of light movement
...
struct Light {  // Light source data type
    vec3 position; // light points have again a position in the world
