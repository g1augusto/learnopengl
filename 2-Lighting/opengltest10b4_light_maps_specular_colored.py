...
Excercise:  Specular maps
            ...
            Excercise:  Try creating a specular map from the diffuse texture that uses actual colors
                        instead of black and white and see that the result doesn't look too realistic.
...
specularMapimage = pygame.image.load("./assets/lighting_maps_specular_color.png") # here we use a colored specular map
