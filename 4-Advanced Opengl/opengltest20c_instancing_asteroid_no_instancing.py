...
Excercise:  Model loading with pyAssimp
...
RockModel = Model(context,prog,RockModelFile)
...
for _ in range(amount):
    ...
    modelMatrices.append(matrix_bytes(model))
...
while True:
    ...
    # render meteorites (without instancing)
    for _ in range(amount):
        prog["model"].write(modelMatrices[_])
        RockModel.Draw(prog)
